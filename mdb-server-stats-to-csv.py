...
#
# See END OF THIS FILE for an example 'mongimport' command to take the content of the generated
# CSV file and import it into a MongoDB database.
##
import sys
import os
import time
...
"""
# Mongoimport example command to import the generated CSV file into an Atlas MongoDB database:
